...
| № лаб | Алгоритм                     | Библиотека (sklearn / XGBoost) | Своя реализация |
|-------|------------------------------|--------------------------------|-----------------|
...
2. Случайный лес занимает уверенное второе место.
...
5. Все ключевые алгоритмы курса реализованы самостоятельно с нуля, результаты близки к библиотечным.
